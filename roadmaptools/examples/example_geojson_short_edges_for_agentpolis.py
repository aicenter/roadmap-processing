...
from roadmaptools import utils, clean_geojson, prepare_geojson_to_agentpolisdemo, simplify_graph, calculate_curvature, \
    create_lanes_connections, estimate_speed_from_osm, remove_specific_line_elements, map_elements, edge_splitter
...
if __name__ == '__main__':
    ...
    if utils.is_geojson_valid(input_geojson):
        ...
        geojson_data = edge_splitter.create_graph_with_short_edges(geojson_data[0])
